...
<link rel="stylesheet" href="<?php echo e(asset("assets/css/form-pem.css")); ?>">
<style>
    .addons {
    display: flex;
...
<div id="section-makesure"  style="background-image:linear-gradient(rgba(0, 0, 0, 0.678), rgba(0, 0, 0, 0.704)),url('<?php echo e(asset("assets/img/hero-section.jpg")); ?>')" class="section-makesure">
    <div>
        <h2 style="color:white"><?php echo e($datas['paket']->nama_paket); ?></h2>
    </div>
    <div class="makesure">
        <div class="detail-makesure">
            <div class="durasi">
                ...
                <div>
                    <h1 style="font-size: 60px">
                        <?php echo e($datas['paket']->durasi_pemotretan); ?>
            ...
            <div class="background">
                ...
                <div class="background-image-makesure">
                    <?php if(count($datas['background_paket']) > 1): ?>
                    <img src="<?php echo e(asset("storage/".$datas['background_paket'][0]['background_url'])); ?>" alt="">
                ...
                <div>
                    <?php if(count($datas['background_paket']) > 1): ?>
                    <h5><?php echo e($datas['background_paket'][0]['background_name']); ?></h5>
        ...
        <div class="action-makesure">
            <a href="<?php echo e(Route("servis-index",$datas["slug"])); ?>"><button type="button" class="btn-secondary">Lihat Paket Lain</button></a>
    ...
    <div class="modal-content" style="width: fit-content">
        ...
        <div class="select-container">
            ...
            <div class="select-options">
                <?php $__currentLoopData = App\Models\ServisTambahan::where("key", "day")->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $as): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label style="font-size: 12px" class="select-option">
                        <input
                        type="checkbox"  value="<?php echo e($as->id_servis); ?>" type="checkbox" name="servis_tambahan[]" class="select-checkbox">  <?php echo e($as->nama_servis); ?> (<?php echo e('Rp ' . number_format((int)$as->harga_servis, 0, ',', '.')); ?>)
                  </label>
 ...
 <div class="modal" id="cetak-modal">
    <div class="modal-content" style="width: fit-content">
        ...
        <div class="select-container">
            ...
            <div class="select-options">
                <?php $__currentLoopData = App\Models\ServisTambahan::where("key", "cetak")->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $as): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label style="font-size: 12px;display:flex;justify-content:space-between" class="select-option">
                        ...
                        <input type="hidden" name="id_servis_lembar[]"  value="<?php echo e($as->id_servis); ?>">
                  </label>
 ...
 <div class="modal" id="file-modal">
    <div class="modal-content" style="width: fit-content">
        <button type="button" style="margin: 2px;border:none;background:none">
            ...
            <input type="text" class="select-input" placeholder="Pilih Add On" disabled>
            <div class="select-options">
                <?php $__currentLoopData = $datas['file_sent']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $as): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label style="font-size: 10px" class="select-option">
                        <input
                        type="checkbox"  value="<?php echo e($as->id_file_sent); ?>" type="checkbox" name="file_sent[]" class="select-checkbox">  <?php echo e($as->nama_file_sent); ?> (<?php echo e('Rp ' . number_format((int)$as->harga_file_sent, 0, ',', '.')); ?>)
                  </label>
 ...
 <div class="modal" id="makeup-modal">
    <div class="modal-content" style="width: fit-content">
        ...
        <div class="select-container">
            <input type="text" class="select-input" placeholder="Pilih Add On" disabled>
            <div class="select-options">
                <?php $__currentLoopData = App\Models\ServisTambahan::where("key", "makeup")->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $as): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label style="font-size: 12px" class="select-option">
                        <input
                        type="checkbox"  value="<?php echo e($as->id_servis); ?>" type="checkbox" name="servis_tambahan[]" class="select-checkbox">  <?php echo e($as->nama_servis); ?> (<?php echo e('Rp ' . number_format((int)$as->harga_servis, 0, ',', '.')); ?>)
                  </label>
  ...
  <div id="section-form-pemesanan-2" class="hidden section-form-bio">
    ...
    <!-- Section 1 -->
    <input type="hidden" name="paket_foto" value="<?php echo e($datas['paket']->id_paket); ?>">
    ...
    <div id="section-form-pemesanan-0" class="section-form-bio hidden">
        ...
        <div class="ipt-container ipt-rek" style="width:90%;font-size: 20px;">
            ...
            <br>
            <div>
                <span style="text-decoration:underline;font-size:15px;cursor: pointer;"><a target="_blank" href="<?php echo e(Route("kalender-index-main")); ?>" style="color:black"><i>Cek Kalender Pemotretan Untuk Melihat Jadwal Kosong</i></a></span>
            </div>
            </div>
        <div class="ipt-container ipt-rek" style="width:90%;font-size: 20px;">
            ...
            max="<?php echo e($datas['paket']->tipe_paket == 0 ? 8 : ($datas['paket']->tipe_paket == 1 ? 12 : 15)); ?>"
        >
        </div>
        <div>
    ...
    <div id="section-form-pemesanan-1" class="section-form-bio hidden">
        <div class="ipt-background" style="font-size: 20px;">
            ...
            <div class="background-form-list">
                ...
                ?>
                <?php $__currentLoopData = $datas['background']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <figure>
                            <center>
                                <img src="<?php echo e(asset('storage/' . $bg->gambar_bg)); ?>" width="300" height="200">
                            </center>
                            <figcaption>
                                <input
                                    <?php if(in_array($bg->id_background, $background_paket_arr)): ?>
                                    checked
                                    <?php endif; ?>
                                    value="<?php echo e($bg->id_background); ?>"
                                    type="checkbox"
                                    name="background[]"
                                    id="background_check"> <!-- Ensure unique IDs -->
                                <span style="font-size:13px;text-align:center;"><?php echo e($bg->nama_background); ?></span>
                            </figcaption>
                        </figure>
...
<div id="addonModal" class="modal1">
    <div class="modal-content1">
        <div class="modal-header1">
            <h2 class="modal-title1">Detail Paket <?php echo e($datas['paket']->nama_paket); ?></h2>
            <button class="close-modal1" onclick="closeAddonModal()">&times;</button>
        </div>
        <div class="modal-body1">
            <div class="paket-price"><?php echo e('Rp ' . number_format((int)$datas['paket']->harga, 0, ',', '.')); ?></div>
            <h3 style="color:#2c4257; text-align:center; margin:15px 0 10px">Benefit Paket:</h3>
            <ul class="paket-items">
                <?php $__currentLoopData = explode(",", $datas['paket']->deskripsi); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datasItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><?php echo e(trim($datasItem)); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
        </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        totalOrangInput.addEventListener("input", function () {
            const tipePaket = <?php echo e($datas['paket']->tipe_paket); ?>;
        ...
        window.addEventListener("load", () => {
            <?php if($datas['paket']->tipe_paket == 0): ?>
    ...
    function cekJadwal() {
        ...
        fetch(`<?php echo e(route('cek-jadwal')); ?>?tanggal_booking=${tanggal_booking.value}&jam_booking=${jam_booking.value}`, {
            method: 'GET',
   ...
   function postPemesanan() {
    ...
    fetch('<?php echo e(route("form-pemesanan-post")); ?>', {
        method: 'POST',
        body: formData,
    ...
    .then(async (response) => {
        ...
        // Berhasil
        loadingLayer.style.display = "none";
        window.location.href = "<?php echo e(route('success-index')); ?>";
    })
    .catch(error => {
        loadingLayer.style.display = "none";
...
<script src="<?php echo e(asset("assets/js/form-pemesanan.js")); ?>"></script>
<script defer src="<?php echo e(asset("assets/js/multiselect-dropdown.js")); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.mainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\code\unlockis\resources\views/content/Main/form-pemesanan.blade.php ENDPATH**/ ?>
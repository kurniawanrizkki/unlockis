<footer id="footer">
    ...
    class="content-footer">
        <div class="logo">
            <img 
            style="width:50px"
            src="<?php echo e(asset("assets/img/logo-unlock.png")); ?>" alt="Logo Unlockis">
        </div>
        ...
        >
           ...
           <div style="display: grid;">
            <?php for($i = 0; $i < $count_layanan; $i++): ?>
            <a 
            style="color:black"
            href="<?php echo e(Route("servis-index", $layanan[$i]->slug)); ?>"><?php echo e($layanan[$i]->nama_layanan_foto); ?></a>
            <?php
                $iteration_layanan++;
           ...
           <div style="display: grid">
            <?php for($i = $iteration_layanan; $i < $count_layanan; $i++): ?>
            <a 
            style="color:black"
            href="<?php echo e(Route("servis-index", $layanan[$i]->slug)); ?>"><?php echo e($layanan[$i]->nama_layanan_foto); ?></a>            <?php endfor; ?>
           </div>
        </div>
        </div>
...
</footer><?php /**PATH C:\code\unlockis\resources\views/content/Main/footer/footer.blade.php ENDPATH**/ ?>
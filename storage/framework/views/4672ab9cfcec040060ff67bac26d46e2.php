...
<script>
    ...
    const generateApiRes = async () => {
        ...
        try {
            const response = await fetch("<?php echo e(Route("chatbot-api")); ?>", {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\code\unlockis\resources\views/content/Main/chatbot.blade.php ENDPATH**/ ?>
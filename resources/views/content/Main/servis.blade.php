        ...
        <div class="paket-layanan-list">
            ...
            <div class="paket" style="color:#2C4257; cursor: pointer;" 
                 onclick="openPaketModal(
                     ...
                     '{{ route('form-pemesanan-index', ['slug' => $datas['layanan_foto']->slug]) }}?nama_paket={{ urlencode($p->nama_paket) }}'
                 )">
                ...
                <div>
                    <span style="font-weight:bold; font-size:18px; color:#2C4257">{{ 'Rp ' . number_format((int)$p->harga, 0, ',', '.') }}</span>
                </div>
            </div>            
            @endforeach
        </div>
